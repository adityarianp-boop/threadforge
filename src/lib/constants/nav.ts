import { LayoutDashboard, Wand2, Lightbulb, FlaskConical, TrendingUp, FolderOpen, MessageCircle, CalendarClock, History, Settings } from "lucide-react";
...
export const appNav = [
  ...
  { href: "/workspace", key: "workspace", icon: FolderOpen },
  { href: "/reply", key: "reply", icon: MessageCircle },
